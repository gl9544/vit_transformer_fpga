...
HD_PWD='D:/BarIlan/DDP/exercises/tutorial/vision_transformer_project/vision_transformer/8.6.23/MLP_final/MLP/MLP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mlp_unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mlp_unit.tcl
